...
document.addEventListener(
  ...
  () => {
    ...
    // getPostList(parentElem, path, limit=10, page=1, useFakeData). page 파라미터는 아직 미구현
    // getPostList(notice, 'notice', NOTICE_LIMIT, 1, true);
    getPostList(post, 'board', POST_LIMIT, currentPage, false);
  },
  false
);
